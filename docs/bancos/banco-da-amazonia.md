...
Documento de referência para conferir a implementação do Banco da Amazônia no PyCobrança, cobrindo boleto, CNAB e validações complementares por banco.
...
- Banco da Amazônia — manual oficial de cobrança/CNAB: Pendente de obtenção no portal oficial do banco ou canal de homologação do gerente.
...
| ---: | ---: | --- | --- |
| A confirmar | A confirmar | Composição específica do Banco da Amazônia. | Pendente de manual/fixture |
...
- Confirmar se o Banco da Amazônia suporta Bolepix por CNAB, API bancária ou ambos.
...
- [ ] Conferir manual vigente do Banco da Amazônia e versionar a referência usada.
