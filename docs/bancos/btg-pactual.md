...
Documento de referência para conferir a implementação do BTG Pactual no PyCobrança, cobrindo boleto, CNAB e validações complementares por banco.
...
| ---: | ---: | --- | --- |
| A confirmar | A confirmar | Composição específica do BTG Pactual. | Pendente de manual/fixture |
...
- Confirmar se o BTG Pactual suporta Bolepix por CNAB, API bancária ou ambos.
...
- [ ] Conferir manual vigente do BTG Pactual e versionar a referência usada.
