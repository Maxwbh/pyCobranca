...
Documento de referência para conferir a implementação do Banco Inter no PyCobrança, cobrindo boleto, CNAB e validações complementares por banco.
...
- [Inter — orientação oficial sobre boleto, CNAB e API](https://blog.bancointer.com.br/boleto-como-o-mei-pode-emitir-sem-pagar/)
...
| ---: | ---: | --- | --- |
| A confirmar | A confirmar | Composição específica do Banco Inter. | Pendente de manual/fixture |
...
- Confirmar se o Banco Inter suporta Bolepix por CNAB, API bancária ou ambos.
...
- [ ] Conferir manual vigente do Banco Inter e versionar a referência usada.
