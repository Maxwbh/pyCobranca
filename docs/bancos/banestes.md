...
Documento de referência para conferir a implementação do Banestes no PyCobrança, cobrindo boleto, CNAB e validações complementares por banco.
...
- Banestes — manual oficial de cobrança/CNAB: Pendente de obtenção no portal oficial do banco ou canal de homologação do gerente.
...
| ---: | ---: | --- | --- |
| A confirmar | A confirmar | Composição específica do Banestes. | Pendente de manual/fixture |
...
- Confirmar se o Banestes suporta Bolepix por CNAB, API bancária ou ambos.
...
- [ ] Conferir manual vigente do Banestes e versionar a referência usada.
