...
Documento de referência para conferir a implementação do Safra no PyCobrança, cobrindo boleto, CNAB e validações complementares por banco.
...
- Safra — manual oficial de cobrança/CNAB: Pendente de obtenção no portal oficial do banco ou canal de homologação do gerente.
...
| ---: | ---: | --- | --- |
| A confirmar | A confirmar | Composição específica do Safra. | Pendente de manual/fixture |
...
- Confirmar se o Safra suporta Bolepix por CNAB, API bancária ou ambos.
...
- [ ] Conferir manual vigente do Safra e versionar a referência usada.
