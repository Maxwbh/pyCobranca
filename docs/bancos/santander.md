...
Documento de referência para conferir a implementação do Santander no PyCobrança, cobrindo boleto, CNAB e validações complementares por banco.
...
| ---: | ---: | --- | --- |
| A confirmar | A confirmar | Composição específica do Santander. | Pendente de manual/fixture |
...
- Confirmar se o Santander suporta Bolepix por CNAB, API bancária ou ambos.
...
- [ ] Conferir manual vigente do Santander e versionar a referência usada.
