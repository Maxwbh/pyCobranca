...
Documento de referência para conferir a implementação do Sicoob no PyCobrança, cobrindo boleto, CNAB e validações complementares por banco.
...
| ---: | ---: | --- | --- |
| A confirmar | A confirmar | Composição específica do Sicoob. | Pendente de manual/fixture |
...
- Confirmar se o Sicoob suporta Bolepix por CNAB, API bancária ou ambos.
...
- [ ] Conferir manual vigente do Sicoob e versionar a referência usada.
