...
Documento de referência para conferir a implementação do Banco do Nordeste no PyCobrança, cobrindo boleto, CNAB e validações complementares por banco.
...
- Banco do Nordeste — manual oficial de cobrança/CNAB: Pendente de obtenção no portal oficial do banco ou canal de homologação do gerente.
...
| ---: | ---: | --- | --- |
| A confirmar | A confirmar | Composição específica do Banco do Nordeste. | Pendente de manual/fixture |
...
- Confirmar se o Banco do Nordeste suporta Bolepix por CNAB, API bancária ou ambos.
...
- [ ] Conferir manual vigente do Banco do Nordeste e versionar a referência usada.
