...
Documento de referência para conferir a implementação do Banco do Brasil no PyCobrança, cobrindo boleto, CNAB e validações complementares por banco.
...
| ---: | ---: | --- | --- |
| A confirmar | A confirmar | Composição específica do Banco do Brasil. | Pendente de manual/fixture |
...
- Confirmar se o Banco do Brasil suporta Bolepix por CNAB, API bancária ou ambos.
...
- [ ] Conferir manual vigente do Banco do Brasil e versionar a referência usada.
