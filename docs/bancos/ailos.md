...
Documento de referência para conferir a implementação do Ailos no PyCobrança, cobrindo boleto, CNAB e validações complementares por banco.
...
- Ailos — manual oficial de cobrança/CNAB: Pendente de obtenção no portal oficial do banco ou canal de homologação do gerente.
...
| ---: | ---: | --- | --- |
| A confirmar | A confirmar | Composição específica do Ailos. | Pendente de manual/fixture |
...
- Confirmar se o Ailos suporta Bolepix por CNAB, API bancária ou ambos.
...
- [ ] Conferir manual vigente do Ailos e versionar a referência usada.
