...
Documento de referência para conferir a implementação do Daycoval no PyCobrança, cobrindo boleto, CNAB e validações complementares por banco.
...
- Daycoval — manual oficial de cobrança/CNAB: Pendente de obtenção no portal oficial do banco ou canal de homologação do gerente.
...
| ---: | ---: | --- | --- |
| A confirmar | A confirmar | Composição específica do Daycoval. | Pendente de manual/fixture |
...
- Confirmar se o Daycoval suporta Bolepix por CNAB, API bancária ou ambos.
...
- [ ] Conferir manual vigente do Daycoval e versionar a referência usada.
