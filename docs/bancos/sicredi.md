...
Documento de referência para conferir a implementação do Sicredi no PyCobrança, cobrindo boleto, CNAB e validações complementares por banco.
...
| ---: | ---: | --- | --- |
| A confirmar | A confirmar | Composição específica do Sicredi. | Pendente de manual/fixture |
...
- Confirmar se o Sicredi suporta Bolepix por CNAB, API bancária ou ambos.
...
- [ ] Conferir manual vigente do Sicredi e versionar a referência usada.
