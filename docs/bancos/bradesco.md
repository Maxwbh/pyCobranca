...
Documento de referência para conferir a implementação do Bradesco no PyCobrança, cobrindo boleto, CNAB e validações complementares por banco.
...
- [Bradesco — Validador de leiautes e arquivos](https://wspf.bradesco.com.br/wsValidadorUniversal/validadorgeral)
...
| ---: | ---: | --- | --- |
| A confirmar | A confirmar | Composição específica do Bradesco. | Pendente de manual/fixture |
...
- Confirmar se o Bradesco suporta Bolepix por CNAB, API bancária ou ambos.
...
- [ ] Conferir manual vigente do Bradesco e versionar a referência usada.
