...
Documento de referência para conferir a implementação do Banrisul no PyCobrança, cobrindo boleto, CNAB e validações complementares por banco.
...
- Banrisul — manual oficial de cobrança/CNAB: Pendente de obtenção no portal oficial do banco ou canal de homologação do gerente.
...
| ---: | ---: | --- | --- |
| A confirmar | A confirmar | Composição específica do Banrisul. | Pendente de manual/fixture |
...
- Confirmar se o Banrisul suporta Bolepix por CNAB, API bancária ou ambos.
...
- [ ] Conferir manual vigente do Banrisul e versionar a referência usada.
