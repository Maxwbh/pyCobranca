...
Documento de referência para conferir a implementação do Itaú no PyCobrança, cobrindo boleto, CNAB e validações complementares por banco.
...
| ---: | ---: | --- | --- |
| A confirmar | A confirmar | Composição específica do Itaú. | Pendente de manual/fixture |
...
- Confirmar se o Itaú suporta Bolepix por CNAB, API bancária ou ambos.
...
- [ ] Conferir manual vigente do Itaú e versionar a referência usada.
