...
Documento de referência para conferir a implementação do Banco Mercantil no PyCobrança, cobrindo boleto, CNAB e validações complementares por banco.
...
- Banco Mercantil — manual oficial de cobrança/CNAB: Pendente de obtenção no portal oficial do banco ou canal de homologação do gerente.
...
| ---: | ---: | --- | --- |
| A confirmar | A confirmar | Composição específica do Banco Mercantil. | Pendente de manual/fixture |
...
- Confirmar se o Banco Mercantil suporta Bolepix por CNAB, API bancária ou ambos.
...
- [ ] Conferir manual vigente do Banco Mercantil e versionar a referência usada.
